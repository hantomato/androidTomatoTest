 ...
 */
public class RecyclerViewTest5Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.with(RecyclerViewTest5Activity.this)
                .load("http://cfile66.uf.daum.net/image/2470F64B5500E65E13CB20")
                .placeholder(R.drawable.image_holder)
                .error(R.drawable.image_error)
                .into(iv1);

        Glide.with(RecyclerViewTest5Activity.this)
                .load("http://cfile66.uf.daum.net/image/2470F64B5500E65E13CB20")
                .placeholder(R.drawable.image_holder)
                .error(R.drawable.image_error)
                .into(iv2);
    ...
    public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
        ...
        public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.row_recyclerview5, parent, false);
